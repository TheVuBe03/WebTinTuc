                    ...
                    <table class="table">
                        ...
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ $post['p_image'] }}" alt="" width="40px">
                                </td>
                                <td>
                        
                                    <a href="/admin/posts/{{ $post['p_id'] }}/show" class="btn btn-success" >Show</a>        
                                    <a href="/admin/posts/{{ $post['p_id'] }}/update" class="btn btn-success" >Update</a>
                                    <a href="/admin/posts/{{ $post['p_id'] }}/delete" 
                                    onclick=" return confirm('Có chắc chắn muốn xóa ko?')"class="btn btn-success" >Delete</a>

                        ...
                        @foreach ($categories as $cat)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/categories/{{ $cat['id'] }}/show" class="btn bg-success" >Show</a>
                                    <a href="/admin/categories/{{ $cat['id'] }}/update" class="btn btn-success" >Update</a>
                                    <a href="/admin/categories/{{ $cat['id'] }}/delete" 
                                    onclick=" return confirm('Có chắc chắn muốn xóa ko?')"
                                    class="btn btn-success" >Delete</a>
                                    <a href="/admin/categories/create" class="btn btn-info">Create

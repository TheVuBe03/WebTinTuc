                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/users/{{ $user['id'] }}/show" class="btn btn-success" >Show</a>        
                                    <a href="/admin/users/{{ $user['id'] }}/update" class="btn btn-success" >Update</a>
                                    <a href="/admin/users/{{ $user['id'] }}/delete" 
                                    onclick=" return confirm('bạn có muốn xóa  ')"class="btn btn-success" >Delete</a>
